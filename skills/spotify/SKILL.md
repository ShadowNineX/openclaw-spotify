...
- Use `spotify_create_playlist`, `spotify_update_playlist`, `spotify_delete_playlist`, `spotify_add_playlist_tracks`, `spotify_remove_playlist_tracks`, and `spotify_reorder_playlist_tracks` only for the authorized user's playlists.
